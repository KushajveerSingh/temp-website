...
- [x] [link](https://github.com/joelparkerhenderson/architecture-decision-record) Architecture Decision Record GitHub
- [x] [link](https://github.com/npryce/adr-tools) adr-tools GitHub
...
- [link](https://www.cncf.io/phippy/the-childrens-illustrated-guide-to-kubernetes/) The Illustrated Guide to Kubernetes
...
- [link](https://commitizen-tools.github.io/commitizen/) commitizen
    - [link](https://commitlint.js.org/) commitlint
- [link](https://github.com/semantic-release/semantic-release) semantic-release
    - [link](https://github.com/conventional-changelog/standard-version) standard-version
- gitattributes
- husky
- litn-staged
- gitkeep
- [link](https://www.openpolicyagent.org/docs) open policy agent
- codeconv, coveralls - code coverage tools
